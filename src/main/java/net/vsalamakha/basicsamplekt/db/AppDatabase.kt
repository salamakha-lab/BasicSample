...
import androidx.sqlite.db.SupportSQLiteDatabase//import com.example.android.persistence.AppExecutors;
import net.vsalamakha.basicsamplekt.AppExecutors
import net.vsalamakha.basicsamplekt.db.converter.DateConverter
import net.vsalamakha.basicsamplekt.db.dao.CommentDao
import net.vsalamakha.basicsamplekt.db.dao.ProductDao
import net.vsalamakha.basicsamplekt.db.entity.CommentEntity
import net.vsalamakha.basicsamplekt.db.entity.ProductEntity
import net.vsalamakha.basicsamplekt.db.entity.ProductFtsEntity
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        @VisibleForTesting
        val DATABASE_NAME = "basic_sample_db"
